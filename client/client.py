...
class Client:
    ...
    def create_buttons(self):
        ...
        btn_temp = tk.Button(self.window, text="Get Temperature", command=self.get_temp, width=15, height=1)
    ...
    def get_temp(self):
        ...
        temperature = session.Session.get_temperature()
    ...
    def toggle_led(self):
        led_state = session.Session.toggle_led()
